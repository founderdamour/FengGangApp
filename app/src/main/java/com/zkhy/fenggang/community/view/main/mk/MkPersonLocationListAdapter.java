 ...
 * 煤矿检测系统适配器
 */
public class MkPersonLocationListAdapter extends RecyclerView.Adapter<MkPersonLocationListAdapter.ViewHolder> {
    ...
    public MkPersonLocationListAdapter(Context context, ArrayList<MkMonitoringSystem2Entity> data) {
        this.data = data;
        mContext = context;
    }
