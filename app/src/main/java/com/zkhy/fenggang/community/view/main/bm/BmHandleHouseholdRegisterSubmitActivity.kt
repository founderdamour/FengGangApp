...
import kotlinx.android.synthetic.main.activity_bm_handle_household_register_submit.*
 ...
 * <pre>
 */
class BmHandleHouseholdRegisterSubmitActivity : TitleBarBaseActivity(), View.OnClickListener, AndroidExt2View {
    ...
    override fun getLayout(): Int = R.layout.activity_bm_handle_household_register_submit
        ...
        when (v) {
            userRegisterImgItem -> {
                IntentUtil.openActivity(
                    this@BmHandleHouseholdRegisterSubmitActivity, BmIDCardUploadActivity::class.java
                )
            ...
            noticeDetailsItem -> {
                IntentUtil.openActivity(
                    this@BmHandleHouseholdRegisterSubmitActivity, BmHandleAllowanceNoticeActivity::class.java
                ).start()
            }
