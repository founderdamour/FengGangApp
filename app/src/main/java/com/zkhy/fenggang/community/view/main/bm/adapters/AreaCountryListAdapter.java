...
/**
 */
public class AreaCountryListAdapter extends RecyclerView.Adapter<AreaCountryListAdapter.ViewHolder> {

    public void setClickCallBack(ItemClickCallBack clickCallBack) {
        this.clickCallBack = clickCallBack;
    }

    public ArrayList<AreaDTO> data = null;
    private ItemClickCallBack clickCallBack;

    public AreaCountryListAdapter(ArrayList<AreaDTO> data) {
        this.data = data;
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        final AreaDTO entity = data.get(position);

        viewHolder.itemTitle.setText(entity.getName());
    ...
    public void setData(ArrayList<AreaDTO> data) {
