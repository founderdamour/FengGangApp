...
import kotlinx.android.synthetic.main.activity_bm_handle_dif_support_submit.*
 ...
 * <pre>
 */
class BmHandleDifficultySupportSubmitActivity : TitleBarBaseActivity(), View.OnClickListener, AndroidExt2View {
    ...
    override fun getLayout(): Int = R.layout.activity_bm_handle_dif_support_submit
...
//        id = intent.getStringExtra("id")
        ...
        when (v) {
            file1Item -> {
                IntentUtil.openActivity(
                    this@BmHandleDifficultySupportSubmitActivity, BmIDCardUploadActivity::class.java
                )
                    .putStringExtra("id", id)
                    .putStringExtra("tip", "身份证")
                    .putStringExtra("bizType", BizType.WU_BM_TK_RY_GY2)
            ...
            file2Item -> {
                IntentUtil.openActivity(
                    ...
                    .putStringExtra("bizType", BizType.WU_BM_TK_RY_GY3)
            ...
            file3Item -> {
                IntentUtil.openActivity(
                    ...
                    .putStringExtra("id", id)
                    .putStringExtra("tip", "书面申请书")
                    .putStringExtra("bizType", BizType.WU_BM_TK_RY_GY4)
                    .putIntExtra("contentType",
                        BmIDCardUploadActivity.RegisterBook
                    )
            ...
            file4Item -> {
                IntentUtil.openActivity(
                    ...
                    .putStringExtra("id", id)
                    .putStringExtra("tip", "残疾证佐证材料")
                    .putStringExtra("bizType", BizType.WU_BM_TK_RY_GY6)
                    .putIntExtra("contentType",
                        BmIDCardUploadActivity.RegisterBook
                    )
            ...
            file5Item -> {
                IntentUtil.openActivity(
                    ...
                    .putStringExtra("id", id)
                    .putStringExtra("tip", "家庭收入及财产证明")
                    .putStringExtra("bizType", BizType.WU_BM_TK_RY_GY5)
                    .putIntExtra("contentType",
                        BmIDCardUploadActivity.RegisterBook
                    )
            ...
            file6Item -> {
                IntentUtil.openActivity(
                    ...
                    .putStringExtra("bizType", BizType.WU_BM_TK_RY_GY7)
                    .putIntExtra("contentType",
                        BmIDCardUploadActivity.RegisterBook
                    )
            ...
            file7Item -> {
                IntentUtil.openActivity(
                    ...
                    .putStringExtra("id", id)
                    .putStringExtra("tip", "特困人员供养申请表")
                    .putStringExtra("bizType", BizType.WU_BM_TK_RY_GY8)
                    .putIntExtra("contentType",
                        BmIDCardUploadActivity.RegisterBook
                    )
    ...
    private fun submit() {
        ...
        if (!file3Img) {
            ToastUtil.show("请先上传书面申请书")
            return
        }

        if (!file4Img) {
            ToastUtil.show("请先上传残疾证佐证材料")
            return
        }

        if (!file5Img) {
            ToastUtil.show("请先上传家庭收入及财产证明")
            return
        }

        if (!file6Img) {
            ToastUtil.show("请先上传区民政局所需材料")
            return
        }

        if (!file7Img) {
            ToastUtil.show("请先上传特困人员供养申请表")
            return
        }
