 ...
 * 就业列表
 */
class EmploymentListActivity : StatusViewRecycleViewBaseActivity(), AndroidExt2View {

    private var presenter: PXPresenter? = null
    private var adapter: TrainListAdapter? = null
    private var pageNo: Int = 0

    override fun getTitleBarView(): View = TitleBarViewCreator.createTitleLC(this, "就业")
