...
class WebPageActivity : TitleBarBaseActivity() {
    ...
    companion object {
        ...
        fun start(activity: FragmentActivity?, titleTxt: String, url: String) {
            val intent = Intent(activity, WebPageActivity::class.java)
            intent.putExtra("webUrl", url)
            intent.putExtra("webTitle", titleTxt)
        ...
        override fun shouldOverrideUrlLoading(view: WebView?, url: String?): Boolean {
            ...
            if (url != null && url.contains(tag)) {
                ...
                if (StringUtil.isNotEmpty(mobile)) {
                    ...
                    try {
                        val uri: Uri = Uri.parse("tel:$mobile")//"tel:$mobile"
