package com.zkhy.fenggang.community.comm.plugin.version;
...
public class VersionDialog {
    ...
    public static void show(final Activity mActivity, final boolean needTip) {
        ...
        RxRetrofit.init(ServerConfig.baseUrl, ServerConfig.getHeaderMap())
                ...
                .subscribe(new Subscriber<BaseData<com.zkhy.fenggang.comm.plugin.version.VersionEntity>>() {
                    @Override
                    ...
                    @Override
                    public void onNext(BaseData<com.zkhy.fenggang.comm.plugin.version.VersionEntity> versionEntityBaseData) {
        ...
        RxRetrofit.init(ServerConfig.baseUrl, ServerConfig.getHeaderMap())
                ...
                .subscribe(new Subscriber<BaseData<com.zkhy.fenggang.comm.plugin.version.VersionEntity>>() {
                    ...
                    @Override
                    public void onNext(BaseData<com.zkhy.fenggang.comm.plugin.version.VersionEntity> result) {

                        if (result.getErrcode() == 0) {
                            if (result.getData() != null) {
                                final com.zkhy.fenggang.comm.plugin.version.VersionEntity version = result.getData();
...
//                                                            UpdateManagerDialog.closeDialog();
     ...
     * @param versionInfo
     */
    private static void downloadFile(Activity mActivity, final com.zkhy.fenggang.comm.plugin.version.VersionEntity versionInfo) {
    ...
    private static void updateDownLoadNum(com.zkhy.fenggang.comm.plugin.version.VersionEntity versionInfo) {
        RxRetrofit.init(ServerConfig.baseUrl, ServerConfig.getHeaderMap())
                .create(AllApi.class)
