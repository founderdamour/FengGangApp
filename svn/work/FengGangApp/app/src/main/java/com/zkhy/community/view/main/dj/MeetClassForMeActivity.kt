...
class MeetClassForMeActivity : StatusViewRecycleViewBaseActivity(), AndroidExt2View {
    ...
    override fun getTitleBarView(): View = TitleBarViewCreator.createTitleLC(this, "我的会议")
