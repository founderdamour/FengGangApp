...
import com.zkhy.fenggang.community.view.main.am.ImpeachDetailActivity
import com.zkhy.fenggang.community.view.main.am.adapter.ImpeachListAdapter
 ...
 */
open abstract class ImpeachListBaseFragment : RecycleViewBaseFragment(), AndroidExt2View {

    private var pageNo: Int = 1
    private var adapter: ImpeachListAdapter? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = ImpeachListAdapter(this.context!!, ArrayList())
        loadingRecyclerView.adapter = adapter
        adapter!!.setClickCallBack(ItemClickCallBack { _, entity ->
            IntentUtil.openActivity(activity, ImpeachDetailActivity::class.java)
    ...
    override fun loadComplete(resultData: Any?) {
        ...
        val result: BaseData<PageData<ImpeachEntity>> = resultData as BaseData<PageData<ImpeachEntity>>
        ...
        if (result.errcode == 0) {
            if (result.data == null || result.data.list == null || result.data.list.size == 0) {
                ...
                // 数据
                val listData = pageData.list as ArrayList<ImpeachEntity>
