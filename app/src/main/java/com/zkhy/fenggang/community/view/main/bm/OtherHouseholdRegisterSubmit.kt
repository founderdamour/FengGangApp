...
import kotlinx.android.synthetic.main.activity_child_household_register_submit.*

/**
 * <pre>
 *  创建:  梁玉涛 2019/5/24 on 14:15
 *  项目: WuMinAndroid
 *  描述:
 *  更新:
 * <pre>
 */
class OtherHouseholdRegisterSubmit : TitleBarBaseActivity(), View.OnClickListener, AndroidExt2View {
    ...
    override fun getLayout(): Int = R.layout.activity_child_household_register_submit
    ...
    override fun onClick(v: View?) {
        when (v) {
            ...
            file01Item -> {
                ...
                fileEntity.bizType = BizType.WU_BM_HJ_JS_ZM3
                ...
                IntentUtil.openActivity(
                    this@OtherHouseholdRegisterSubmit, FileUploadCommActivity::class.java
                )
            ...
            file02Item -> {
                ...
                fileEntity.bizType = BizType.WU_BM_HJ_JS_ZM2
            ...
            file03Item -> {
                ...
                fileEntity.bizType = BizType.WU_BM_HJ_JS_ZM4
            ...
            file04Item -> {
                ...
                fileEntity.bizType = BizType.WU_BM_HJ_JS_ZM5
    ...
    private fun submit() {
        ...
        vo.flowId = BizType.FlowType.FLOW_21
        vo.handleType = 1
