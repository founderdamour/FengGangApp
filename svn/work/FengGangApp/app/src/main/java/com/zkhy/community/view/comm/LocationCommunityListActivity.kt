...
import com.zkhy.community.view.main.zm.WishAddActivity
 ...
 * <pre>
 */
class LocationCommunityListActivity : StatusViewBaseActivity(), AndroidExt2View {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter!!.setClickCallBack(ItemClickCallBack<AreaDTO> { _, entity ->
            ...
            intent.putExtra("areaCode", entity.code)
            intent.putExtra("areaName", entity.name)
