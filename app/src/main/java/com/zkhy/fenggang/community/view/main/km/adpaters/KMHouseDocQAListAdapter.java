...
/**
 */
public class KMHouseDocQAListAdapter extends RecyclerView.Adapter<KMHouseDocQAListAdapter.ViewHolder> {
    ...
    public KMHouseDocQAListAdapter(ArrayList<HouseDocQAEntity> data) {
        this.data = data;
    }
    ...
    public void addData(ArrayList<HouseDocQAEntity> data) {
        if (this.data == null) {
