...
class WishFromMeListActivity : StatusViewRecycleViewBaseActivity(), AndroidExt2View {

    private var presenter: ZMPresenter? = null
    private var adapter: WishListAdapter? = null
    private var pageNo: Int = 0

    override fun getTitleBarView(): View = TitleBarViewCreator.createTitleLC(this, "我的认领")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter!!.setClickCallBack(ItemClickCallBack<WishEntity> { _, entity ->
            ...
            IntentUtil.openActivity(this@WishFromMeListActivity, WishDetailsActivity::class.java)
                .putIntExtra("flag", 1) // 入口分类
