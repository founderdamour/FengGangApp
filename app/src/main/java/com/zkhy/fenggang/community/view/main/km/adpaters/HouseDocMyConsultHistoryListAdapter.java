package com.zkhy.fenggang.community.view.main.km.adpaters;
...
/**
 */
public class HouseDocMyConsultHistoryListAdapter extends RecyclerView.Adapter<HouseDocMyConsultHistoryListAdapter.ViewHolder> {

    public void setClickCallBack(ItemClickCallBack clickCallBack) {
        this.clickCallBack = clickCallBack;
    }

    public ArrayList<HouseDocQAEntity> data = null;
    private ItemClickCallBack clickCallBack;

    public HouseDocMyConsultHistoryListAdapter(ArrayList<HouseDocQAEntity> data) {
        this.data = data;
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        final HouseDocQAEntity entity = data.get(position);
    ...
    public void setData(ArrayList<HouseDocQAEntity> data) {
    ...
    public void addData(ArrayList<HouseDocQAEntity> listData) {
