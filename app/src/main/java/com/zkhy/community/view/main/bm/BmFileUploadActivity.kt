...
class BmFileUploadActivity : TitleBarBaseActivity(), View.OnClickListener {
    ...
    override fun getLayout(): Int = R.layout.activity_bm_file_upload
        ...
        RxRetrofit.init(ServerConfig.baseUrl, ServerConfig.getHeaderMap()).create(AllApi::class.java)
            ...
            .subscribe(object : Subscriber<BaseData<AttachmentEntity>>() {
                ...
                override fun onStart() {
                    super.onStart()
                    LoadingDialog.show(this@BmFileUploadActivity, "正在提交")
                }
