...
import kotlinx.android.synthetic.main.activity_poor_family_submit.*

/**
 * <pre>
 *  创建:  梁玉涛 2019/5/24 on 14:13
 *  项目: WuMinAndroid
 *  描述: activity_poor_family_submit
 *  更新:
 * <pre>
 */
class OtherPoorFamilySubmit : TitleBarBaseActivity(), View.OnClickListener, AndroidExt2View {
    ...
    override fun getLayout(): Int = R.layout.activity_poor_family_submit

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setTitleBar("家庭生活困难证明")
    ...
    override fun onClick(v: View?) {
        when (v) {
            ...
            file01Item -> {
                ...
                fileEntity.bizType = BizType.WU_BM_JT_SH_KN_ZM3
                ...
                IntentUtil.openActivity(
                    this@OtherPoorFamilySubmit, FileUploadCommActivity::class.java
                )
            ...
            file02Item -> {
                ...
                fileEntity.bizType = BizType.WU_BM_JT_SH_KN_ZM2
            ...
            file03Item -> {
                val fileEntity = BmFileEntity()
                fileEntity.bizId = id
                fileEntity.titleStr = "其他困难证明材料"
                fileEntity.tip = "请上传有关单位出具的困难证明材料图片"
                fileEntity.bizType = BizType.WU_BM_JT_SH_KN_ZM4
...
//    private var file03IsUpload = false
    ...
    private fun submit() {
        ...
        vo.flowId = BizType.FlowType.FLOW_23
        vo.handleType = 1
        ...
        if (file03List == null || file03List!!.size == 0) {
            ToastUtil.show("请先上传有关单位出具的困难证明资料")
            return
        }
