 ...
 * <pre>
 */
class ComplaintDetailActivity : StatusViewTitleBarActivity(), AndroidExt2View {
    var id = ""
    var presenter: AMPresenter? = null

    override fun getTitleBarView(): View = TitleBarViewCreator.createTitleLC(this, "咨询投诉详情")

    override fun getContentLayoutId(): Int = R.layout.activity_am_complaint_detail
    ...
    override fun loadData() {
        ...
        presenter?.loadComplaintDetail(id)
    }

    private fun initView(data: ComplaintEntity) {
    ...
    override fun loadComplete(resultData: Any?) {
        if (resultData != null) {
            val data: ComplaintEntity = resultData as ComplaintEntity
