...
import kotlinx.android.synthetic.main.activity_bm_handle_temp_help_submit.*
 ...
 * <pre>
 */
class BmHandleTempAssistanceSubmitActivity : TitleBarBaseActivity(), View.OnClickListener, AndroidExt2View {
    ...
    override fun getLayout(): Int = R.layout.activity_bm_handle_temp_help_submit
...
//                    this@BmHandleTempAssistanceSubmitActivity, BmIDCardUploadActivity::class.java
//                )
...
//            }
            ...
            noticeDetailsItem -> {
                IntentUtil.openActivity(
                    this@BmHandleTempAssistanceSubmitActivity, BmHandleAllowanceNoticeActivity::class.java
                ).start()
            }
